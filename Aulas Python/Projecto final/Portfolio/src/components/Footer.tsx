...
import { GithubIcon, LinkedinIcon, SquareTerminal } from 'lucide-react';
export function Footer() {
  const currentYear = new Date().getFullYear();
  return <footer className="bg-gray-800 dark:bg-gray-900 text-white py-4 transition-colors duration-200">
